...
N 2570 -1050 2600 -1050 {lab=VOUT}
N 1250 -910 1280 -910 {lab=GND}
N 1340 -910 1420 -910 {lab=VIN2}
N 1340 -1050 1420 -1050 {lab=VIN1}
N 1500 -1050 1540 -1050 {lab=#net1}
N 2340 -1050 2390 -1050 {lab=TopAftBuf}
N 1860 -910 2390 -1030 {lab=BotAftBuf}
N 2410 -1330 2410 -1300 {lab=VDD}
N 2410 -1240 2410 -1200 {lab=GND}
N 1620 -1050 1660 -1050 {lab=#net2}
N 1740 -1050 1780 -1050 {lab=#net3}
N 1860 -1050 1900 -1050 {lab=#net4}
N 1980 -1050 2020 -1050 {lab=#net5}
N 2100 -1050 2140 -1050 {lab=#net6}
N 2220 -1050 2260 -1050 {lab=#net7}
N 1500 -910 1540 -910 {lab=#net8}
N 1620 -910 1660 -910 {lab=#net9}
N 1740 -910 1780 -910 {lab=#net10}
C {sky130_stdcells/dlxtp_1.sym} 2480 -1040 0 0 {name=x2 VGND=0 VNB=0 VPB=VDD VPWR=VDD prefix=sky130_fd_sc_hd__ }
...
plot v(VIN1) v(VIN2) v(TopAftBuf) v(BotAftBuf) v(VOUT)
.endc

.options acct list
.option numdgt=6
" }
C {lab_pin.sym} 2370 -1050 1 0 {name=p4 sig_type=std_logic lab=TopAftBuf}
C {lab_pin.sym} 2590 -1050 1 0 {name=p7 sig_type=std_logic lab=VOUT}
...
C {lab_pin.sym} 1860 -910 3 0 {name=p6 sig_type=std_logic lab=BotAftBuf}
C {ngspice_probe.sym} 2590 -1050 0 0 {name=r2}
C {ngspice_probe.sym} 2370 -1050 0 0 {name=r1}
C {ngspice_probe.sym} 1400 -1050 0 0 {name=r3}
C {ngspice_probe.sym} 1380 -910 0 0 {name=r4}
C {ngspice_probe.sym} 1860 -910 0 0 {name=r5}
