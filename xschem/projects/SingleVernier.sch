...
N 2170 -1050 2200 -1050 {lab=VOUT}
...
N 1860 -1050 1880 -1050 {lab=#net6}
N 1740 -910 1770 -910 {lab=#net7}
N 1960 -1050 1990 -1050 {lab=#net8}
N 1850 -910 1990 -910 {lab=OUT2}
N 1990 -1030 1990 -910 {lab=OUT2}
...
.control
tran 10p 30n
write SingleVernier.raw
plot v(VIN1) v(VOUT)
.endc

.options acct list
" }
C {lab_pin.sym} 2190 -1050 1 0 {name=p7 sig_type=std_logic lab=VOUT}
...
C {ngspice_probe.sym} 2190 -1050 0 0 {name=r2}
...
C {sky130_stdcells/dlxtp_1.sym} 2080 -1040 0 0 {name=x2 VGND=0 VNB=0 VPB=VDD VPWR=VDD prefix=sky130_fd_sc_hd__ }
