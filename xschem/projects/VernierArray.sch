...
S {}
E {}
N -1510 -340 -1480 -340 {lab=GND}
N -620 -360 -540 -360 {lab=VIN1}
N -150 -580 -150 -550 {lab=VDD}
N -150 -490 -150 -450 {lab=GND}
N -240 -340 -200 -340 {lab=TEST2}
N -240 -360 -200 -360 {lab=TEST1}
N 100 -360 120 -360 {lab=#net1}
N 100 -340 120 -340 {lab=#net2}
N 420 -360 440 -360 {lab=#net3}
N 420 -340 440 -340 {lab=#net4}
...
N -1420 -340 -1400 -340 {lab=#net5}
N -1320 -340 -1300 -340 {lab=#net6}
N -1220 -340 -1200 -340 {lab=#net7}
N -560 -210 1140 -210 {lab=VDD}
N 1140 -210 1980 -210 {lab=VDD}
N 1060 -340 1100 -340 {lab=#net8}
N 1060 -360 1100 -360 {lab=#net9}
N 1400 -360 1420 -360 {lab=#net10}
N 1400 -340 1420 -340 {lab=#net11}
N 1720 -360 1740 -360 {lab=#net12}
N 1720 -340 1740 -340 {lab=#net13}
...
N 740 -340 760 -340 {lab=#net14}
N 740 -360 760 -360 {lab=#net15}
N -1120 -340 -1100 -340 {lab=#net16}
N -1020 -340 -1000 -340 {lab=#net17}
N -920 -340 -900 -340 {lab=#net18}
N -820 -340 -800 -340 {lab=#net19}
N -680 -380 -680 -360 {lab=GND}
N -720 -340 -540 -340 {lab=VIN2}
C {vsource.sym} -1450 -340 1 0 {name=V1 value="PULSE(0 1.8 0n 100p 100p 5n 20n)" savecurrent=false}
...
C {gnd.sym} -1510 -340 1 0 {name=l1 lab=GND}
C {lab_pin.sym} -560 -210 2 1 {name=p4 sig_type=std_logic lab=VDD
}
C {gnd.sym} -620 -240 0 0 {name=l4 lab=GND}
C {sky130_stdcells/buf_1.sym} -1360 -340 0 0 {name=x13 VGND=GND VNB=GND VPB=VDD VPWR=VDD prefix=sky130_fd_sc_hd__ }
C {sky130_stdcells/buf_1.sym} -1260 -340 0 0 {name=x5 VGND=GND VNB=GND VPB=VDD VPWR=VDD prefix=sky130_fd_sc_hd__ }
C {sky130_stdcells/buf_1.sym} -1160 -340 0 0 {name=x6 VGND=GND VNB=GND VPB=VDD VPWR=VDD prefix=sky130_fd_sc_hd__ }
C {VernierSymbol.sym} -50 -330 0 0 {name=x1}
C {VernierSymbol.sym} -390 -330 0 0 {name=x2}
C {VernierSymbol.sym} 270 -330 0 0 {name=x3}
C {VernierSymbol.sym} 590 -330 0 0 {name=x4}
C {VernierSymbol.sym} 910 -330 0 0 {name=x7}
C {VernierSymbol.sym} 1250 -330 0 0 {name=x8}
C {VernierSymbol.sym} 1570 -330 0 0 {name=x9}
C {VernierSymbol.sym} 1890 -330 0 0 {name=x10}
C {sky130_stdcells/buf_1.sym} -1060 -340 0 0 {name=x11 VGND=GND VNB=GND VPB=VDD VPWR=VDD prefix=sky130_fd_sc_hd__ }
C {sky130_stdcells/buf_1.sym} -960 -340 0 0 {name=x12 VGND=GND VNB=GND VPB=VDD VPWR=VDD prefix=sky130_fd_sc_hd__ }
C {sky130_stdcells/buf_1.sym} -860 -340 0 0 {name=x14 VGND=GND VNB=GND VPB=VDD VPWR=VDD prefix=sky130_fd_sc_hd__ }
C {sky130_stdcells/buf_1.sym} -760 -340 0 0 {name=x15 VGND=GND VNB=GND VPB=VDD VPWR=VDD prefix=sky130_fd_sc_hd__ }
C {lab_pin.sym} -220 -360 1 0 {name=p6 sig_type=std_logic lab=TEST1}
C {lab_pin.sym} -220 -340 3 0 {name=p7 sig_type=std_logic lab=TEST2}
